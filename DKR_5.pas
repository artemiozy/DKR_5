...
procedure DevyatihvostiyLisStalDevyatimHokage(a, c: integer);
var
    x, j, i, n1, n2: integer;
    rez: array[1..1000] of char;
begin
    ...
    begin
        x := (a + c) div 2;
        DevyatihvostiyLisStalDevyatimHokage(a, x);
        DevyatihvostiyLisStalDevyatimHokage(x + 1, c);
        n1 := a;
        n2 := x + 1;
        for i := a to c do 
        begin
...
begin
  assign(input, 'I:\oaip\DomZad5\text.txt'); assign(output, 'I:\oaip\DomZad5\text1.txt');
  ...
  begin
    ...
    case st of
      ...
      2: pipis(1, n);
      3: navoz;
      4: DevyatihvostiyLisStalDevyatimHokage(1, n);
      0: exit;
    end;
    for var i := 1 to n do
      print(output, arr[i]);
